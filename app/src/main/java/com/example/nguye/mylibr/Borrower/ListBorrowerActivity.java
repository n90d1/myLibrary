...
public class ListBorrowerActivity extends AppCompatActivity {
    ...
    String linkGetBorrower= "http://192.168.43.168:5000/listBorrower";
...
//                showDetailDialogBo();
    ...
    public String linkDelBo(int borrowerId){
        //10.18.101.162|| wifi FPT Polytechnic
        //10.0.136.36|| wifi Mang Day KTX
        String linkDelBo = "http://192.168.43.168:5000/deleteBorrower?borrowerId="+borrowerId;
        return linkDelBo;
    }
    ...
    public String linkFindBoById(int borrowerId){
        //10.18.101.162|| wifi FPT Polytechnic
        //10.0.136.36|| wifi Mang Day KTX
        String linkFindIdBook = "http://192.168.43.168:5000/findBorrowerById?borrowerId="+borrowerId;
        return linkFindIdBook;
    }
    //Link tìm người dùng theo tên
    public String linkFindBoByName(String borrowerName){
        //10.18.101.162|| wifi FPT Polytechnic
        //10.0.136.36|| wifi Mang Day KTX
        String linkFindNBook = "http://192.168.43.168:5000/findBorrowerByName?borrowerName="+borrowerName;
